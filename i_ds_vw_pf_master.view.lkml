view: i_ds_vw_pf_master {
  sql_table_name: dbo.iDS_vw_PF_Master ;;
  ...
  dimension: ids_short_filename {
    type: string
    sql: ${TABLE}.ids_short_filename ;;
  }
  ...
  measure: count {
    type: count
    drill_fields: [filename, ids_device_name, ids_short_filename]
  }
}
